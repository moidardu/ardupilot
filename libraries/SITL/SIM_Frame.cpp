...
static Motor octa_motors[] =
{
    Motor(AP_MOTORS_MOT_1,    220,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1),
    Motor(AP_MOTORS_MOT_2,  -1580,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  5),
    Motor(AP_MOTORS_MOT_3,   430,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 2),
    Motor(AP_MOTORS_MOT_4,  1580,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4),
    Motor(AP_MOTORS_MOT_5,  -220,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 8),
    Motor(AP_MOTORS_MOT_6, -1370,  AP_MOTORS_MATRIX_YAW_FACTOR_CW, 6),
    Motor(AP_MOTORS_MOT_7,  -430,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  7),
    Motor(AP_MOTORS_MOT_8,   1370,  AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  3)
};
