...
bool AP_MotorsMatrix::setup_octa_matrix(motor_frame_type frame_type)
{
    ...
    case MOTOR_FRAME_TYPE_H: {
        ...
        static const AP_MotorsMatrix::MotorDefRaw motors[] {
            { -0.4f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1 },
            {  0.4f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  5 },
            { -0.4f,   0.43f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW+0.3, 2 },
            { -0.4f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4 },
            {  0.4f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 8 },
            {  0.4f,  -0.43f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW+0.3, 6 },
            {  0.4f,   0.43f, AP_MOTORS_MATRIX_YAW_FACTOR_CW-0.3,  7 },
            { -0.4f,  -0.43f, AP_MOTORS_MATRIX_YAW_FACTOR_CW-0.3,  3 },
        };
        add_motors_raw(motors, ARRAY_SIZE(motors));
        break;
